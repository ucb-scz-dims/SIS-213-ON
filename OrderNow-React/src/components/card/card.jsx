...
const Card = ({path, alt, fit, title, desc, price, disabled}) => {
    return (
        ...
        <div
        class="w-72 h-40 flex flex-col justify-center gap-2 bg-neutral-50 rounded-lg shadow p-2 disabled:pointer-events-none" disabled={disabled}
        >
        <div class="flex gap-2">
            <img class={"bg-neutral-500 w-24 h-24 shrink-0 rounded-lg " + fit} alt={alt} src={path} title={alt}/>
            <div class="flex flex-col">
            <span class="font-bold text-neutral-700 italic">{title}</span>
