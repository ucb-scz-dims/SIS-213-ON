...
const TarjetaRestaurante = ({ id, nombre, descripcion, estrellas, comidas }) => {
  ...
  return (
    <div 
      onClick={handleClick}
      className="border border-gray-300 rounded-xl p-4 shadow-md w-100 cursor-pointer hover:shadow-lg transition-shadow mb-4"
    >
      ...
      <div className="overflow-x-auto whitespace-nowrap py-2 mb-4 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200">
